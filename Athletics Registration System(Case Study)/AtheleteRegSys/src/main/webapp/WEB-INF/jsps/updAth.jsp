...
<body>
<form action="updAthelete" method="post">
	<table border="1">
	<tr>
	<td>Athlete Id</td><td><input type="text" name="updId"></td>
	</tr>
	<tr>
	<tr>
	...
	<tr>
	<td><input type="submit" value="Update"> <input type="button" value="Cancel" onclick="window.location = 'home';"></td>
